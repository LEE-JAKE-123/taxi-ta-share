    ...
    <MobileShell withTabBar={false}>
      ...
      <main className="flex flex-1 flex-col gap-6 px-5 py-5">
        ...
        <section aria-labelledby="action-required-heading">
          <div className="mb-3">
            <h2 id="action-required-heading" className="text-lg font-extrabold">
              조치 필요
            </h2>
        ...
        <section aria-labelledby="monitoring-heading">
          <div className="mb-3">
            <h2 id="monitoring-heading" className="text-lg font-extrabold">
              모니터링
            </h2>
            <p className="mt-1 text-sm text-muted-foreground">
        ...
        <section aria-labelledby="trip-status-heading">
          <div className="mb-3 flex items-center gap-2">
            ...
            <h2 id="trip-status-heading" className="text-lg font-extrabold">
              모집 상태 요약
            </h2>
          </div>
